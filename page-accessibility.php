...
<div role="main">
    <div class="row">
            ...
            <div class="main-content">
                <div class="accessibility-content" style="max-width: 960px; margin: 0 auto; padding: 20px;">
                <?php if ( function_exists('yoast_breadcrumb') ) {
                    yoast_breadcrumb('<p id="breadcrumbs">','</p>');
                    } ?>
                     <h1 class="page-header entry-title">Accessibility</h1>
                    ...
                    <p>We are always seeking opportunities to improve website accessibility. If you experience any difficulty in accessing this website, please don't hesitate to contact us at <?= do_shortcode('[client_info field="new_lead_number"]'); ?>.</p>
                </div>
        </div>
</div>
        <?php get_footer(); ?>